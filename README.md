...
```
wget -N https://raw.githubusercontents.com/demo2099/xrayplus-script/master/install.sh && bash install.sh
```
...
[![Stargazers over time](https://starchart.cc/demo2099/xrayplus.svg)](https://starchart.cc/demo2099/xrayplus)
